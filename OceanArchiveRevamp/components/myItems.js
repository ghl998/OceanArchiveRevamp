    ...
    render() {
        ...
        return (React.createElement("div", { className: "ICAcontainer" },
            ...
            React.createElement("div", { className: 'listSection' },
                ...
                this.dataSet.slice(currentPage * this.itemsPerPage, (currentPage + 1) * this.itemsPerPage).map((data, i) => React.createElement(ListItem, { key: i, published: true, dateCreated: "02-Jun-2020", title: data, creators: 'Territorial Agency' }))),
